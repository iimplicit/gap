  ...
  app.controller("surveyNewPageController", ["$scope", "$http", "$routeParams", "$window",
        function($scope, $http, $routeParams, $window) {
            ...
            $scope.create = function(survey) {
                ...
                $http.post("http://dev.geec.info:3000/api/surveys", survey).
    ...
    app.controller("surveyEditPageController", ["$scope", "$http", "$routeParams", "$window",
        function($scope, $http, $routeParams, $window) {
            ...
            // http://dev.geec.info:3000/api/surveys/54d1374ea0f09231943ee5d2
            $http.get("http://dev.geec.info:3000/api/surveys/" + $routeParams.id).
            success(function(data) {
            ...
            $scope.update = function(survey) {
                ...
                $http.put("http://dev.geec.info:3000/api/surveys/" + $routeParams.id, survey).
                success(function(data) {
                    console.log("success")
